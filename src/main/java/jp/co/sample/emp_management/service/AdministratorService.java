...
public class AdministratorService {
	...
	public Administrator login(String mailAddress, String password) {
		...
		String hashedPassword = findByMailAddress(mailAddress).getPassword();
		
		if(passwordEncoder.matches(password, hashedPassword)){
			administrator = administratorRepository.findByMailAddressAndPassward(mailAddress, hashedPassword);			
		}
